...
def run_pipeline_oof_fullstack(
    ...
    proto_n_epochs = int(CFG.get("proto_n_epochs", 40))
    proto_patience = int(CFG.get("proto_patience", 8))
    proto_lr = float(CFG.get("proto_lr", 1e-3))
    proto_n_sites = int(CFG.get("proto_n_sites", 20))
