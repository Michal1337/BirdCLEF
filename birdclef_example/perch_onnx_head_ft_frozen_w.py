...
VAL_SIZE = 0.2
SEED = 42
SAVE_HEAD_PATH: Path | None = REPO_ROOT / "outputs" / "experiments_ft" / "perch_onnx_head_ft_frozen_w_best.pt"
...
GRID_RESULTS_CSV: Path | None = REPO_ROOT / "outputs" / "eda" / "perch_onnx_head_ft_frozen_w_grid_results.csv"
W_TRAIN_MODE = "frozen"
