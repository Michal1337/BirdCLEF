"""Converted from birdclef-26-two-pass-ssm-advanced-pp.ipynb.
Order: imports, definitions, configs/init variables, execution.

Notebook configs are preserved verbatim (CFG nested structure with
proto_ssm_train / residual_ssm / mlp_params). The full-stack OOF
validation, sweep loop, and metric-saving were added in the style of
sota_oof.py — the sweep overrides flat top-level CFG keys.
"""
