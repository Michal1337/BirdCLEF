...
VAL_SIZE = 0.2
SEED = 42
SAVE_HEAD_PATH: Path | None = REPO_ROOT / "outputs" / "experiments_ft" / "perch_onnx_head_ft_frozen_w_audio_best.pt"
...
def extract_spatial_and_logits(
    ...
    so.intra_op_num_threads = int(os.environ.get("ORT_INTRA_OP_THREADS", "8"))
