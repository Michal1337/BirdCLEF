...
CACHE_META = BASE / "data" / "perch_cache" / "full_perch_meta.parquet"
CACHE_NPZ = BASE / "data" / "perch_cache" / "full_perch_arrays.npz"
...
# Test patch: force finetuned 28-class outputs to zero before saving.
FT28_ZERO_COLS = [
    "116570",
    "47158son01",
    "47158son02",
...
ft28_cols = [c for c in FT28_ZERO_COLS if c in sub.columns]
if ft28_cols:
    sub.loc[:, ft28_cols] = 0.0
    print(f"Applied test patch: zeroed {len(ft28_cols)} finetuned classes")
