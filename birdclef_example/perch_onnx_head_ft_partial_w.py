...
VAL_SIZE = 0.2
SEED = 42
SAVE_HEAD_PATH: Path | None = REPO_ROOT / "outputs" / "experiments_ft" / "perch_onnx_head_ft_partial_w_best.pt"
...
GRID_RESULTS_CSV: Path | None = REPO_ROOT / "outputs" / "eda" / "perch_onnx_head_ft_partial_w_grid_results.csv"
...
def main() -> None:
    ...
    print(f"Using files: {len(soundscape_paths)}")
    ...
    spatial_train = spatial_soundscape_train
    target_train = target_soundscape_train
